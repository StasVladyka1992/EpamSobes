...
public class Theory<T> {
    ...
    // Если у ссылки я не указываю тип параметра, то она банально будет параметризована типом Object:
    ...
    //стирание типов:
    //В кратце Если ты попытаешься положить объект не того типа в свой List<String>, компилятор выдаст ошибку.
    // Этого как раз и добивались создатели языка, создавая дженерики — проверки на этапе компиляции.
...
//    https://javarush.ru/groups/posts/2310-dzheneriki-na-kotikakh
