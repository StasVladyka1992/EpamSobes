...
*/
//Суть: Соседи постоянно «сравниваются» и меняются местами, пока самый большой потихоньку не уплывёт на верх.
public class BubbleSort {
	...
	public int[] bubbleSort(int[] array) { ///for one element - 1 full iteration => n*n = n^2
