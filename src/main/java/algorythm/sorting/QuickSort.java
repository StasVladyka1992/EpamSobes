...
2) Сооздаем два новых массива, в один из которых складываются элементы МЕНЬШЕ опорного, а в другой - БОЛЬШЕ
...
Aлгоритмическая сложность: средний случай он же лучший -  O(n) *O(log n) = O(n*log n)
						   худший случай - O(n^2)
