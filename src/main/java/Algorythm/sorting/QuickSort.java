...
2) Сооздаем два новых массива, в один и которых складываются элементы МЕНЬШЕ опорного, а в другой - БОЛЬШЕ
3) Сортируем левый и правый массив с пмощью рекурсии, т.е. повторяем шаги с 1 по 3.
