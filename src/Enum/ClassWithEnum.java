...
public class ClassWithEnum {
    public static void main(String[] args) {
        ...
        //
        //Ошибка компиляции, чтобы попытаться явно создать экземпляр типа перечисления.
        // Метод final clone в enum гарантирует, что константы enum никогда не могут быть клонированы,
